...
// mock
import { contactEmail } from '../constants/profile';
            ...
            <div className="-m-2 flex flex-wrap">
              <div className="w-full p-2 sm:w-1/2">
                ...
                <input
                  ...
                  name="user_name"
                  className="w-full rounded border border-primary-700/70 bg-primary-100/20 px-3 py-1 text-base leading-8 outline-none transition-colors duration-200 ease-in-out focus:ring-1 focus:ring-primary-700/70 dark:border-primary-300/50 dark:bg-primary-300/10 dark:focus:ring-primary-300/50"
                />
              </div>
              <div className="w-full p-2 sm:w-1/2">
                ...
                <input
                  ...
                  id="email"
                  required
                  placeholder="contact@frederickbruce.me"
                  name="user_email"
                  className="w-full rounded border border-primary-700/70 bg-primary-100/20 px-3 py-1 text-base leading-8 outline-none transition-colors duration-200 ease-in-out focus:ring-1 focus:ring-primary-700/70 dark:border-primary-300/50 dark:bg-primary-300/10 dark:focus:ring-primary-300/50"
                />
              </div>
              <div className="w-full p-2">
                ...
                <textarea
                  ...
                  name="message"
                  required
                  className="h-32 w-full resize-none rounded border border-primary-700/70 bg-primary-100/20 px-3 py-1 text-base leading-8 outline-none transition-colors duration-200 ease-in-out focus:ring-1 focus:ring-primary-700/70 dark:border-primary-300/50 dark:bg-primary-300/10 dark:focus:ring-primary-300/50"
                  defaultValue={''}
                />
              </div>
              ...
              <div className="mt-4 w-full border-t border-neutral-700/50 p-2 pt-6 text-center dark:border-neutral-300/50">
                <a
                  href={`mailto:${contactEmail}?subject=Inquiry&body=Hello, Frederick`}
